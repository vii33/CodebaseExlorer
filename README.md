...
This repository contains a codebase-level documentation pass for [`vii33/MiniClaw`](https://github.com/vii33/MiniClaw), based on the current `main` branch structure and source files.
